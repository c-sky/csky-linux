...
-------------------------------------------------------------------------------
*/
#include "softfloat-specialize.c"
...
static uint32 roundAndPackUint32(struct roundingData *roundData, bits64 absZ)
{
    int8 roundingMode;
    flag roundNearestEven;
    int8 roundIncrement, roundBits;
...
-------------------------------------------------------------------------------
*/
float32 int32_to_float32(int32 a, struct roundingData *roundData)
{
    flag zSign;
...
float32 uint32_to_float32(uint32 a, struct roundingData *roundData)
{
    return float64_to_float32(uint32_to_float64(a), roundData);
//    flag zSign;
...
-------------------------------------------------------------------------------
*/
int32 float32_to_int32(float32 a, struct roundingData *roundData)
{
    flag aSign;
...
uint32 float32_to_uint32(float32 a, struct roundingData *roundData)
{
    ...
    zSig <<= 32;
    if ( 0 < shiftCount ) shift64RightJamming( zSig, shiftCount, &zSig );
    return roundAndPackUint32( roundData, zSig );
...
int32 float32_to_int32_round_to_zero( float32 a )
{
    ...
    if ( 0 <= shiftCount ) {
        ...
        raise_float_exception( float_flag_invalid );
        if ( ! aSign || ( ( aExp == 0xFF ) && aSig ) ) return 0x7FFFFFFF;
        return 0x80000000;
    }
    else if ( aExp <= 0x7E ) {
        if ( aExp | aSig ) raise_float_exception( float_flag_inexact );
        return 0;
    }
    aSig = ( aSig | 0x00800000 )<<8;
    z = aSig>>( - shiftCount );
    if ( (bits32) ( aSig<<( shiftCount & 31 ) ) ) {
        raise_float_exception( float_flag_inexact );
    }
    return aSign ? - z : z;
...
-------------------------------------------------------------------------------
*/
int32 float64_to_int32(float64 a, struct roundingData *roundData)
{
    flag aSign;
    int16 aExp, shiftCount;
    bits64 aSig;
...
*/
#if 1
int32 float64_to_uint32(float64 a, struct roundingData *roundData)
{
    flag aSign;
    int16 aExp, shiftCount;
    bits64 aSig;
    ...
    shiftCount = 0x42C - aExp;
    if ( 0 < shiftCount ) shift64RightJamming( aSig, shiftCount, &aSig );
    return roundAndPackUint32( roundData, aSig );
}
#else
/* arm bug ?*/
int32 float64_to_uint32(float64 a, struct roundingData *roundData)
